	...
	Page {
		...
		onCreationCompleted: {
			...
			app.NickSet.connect(function(jid, nickname) {
				...
				nicknames = tmp;
				dm.query.emitDataChanged(parseInt(new Data().getTime() / 1000));
			});
